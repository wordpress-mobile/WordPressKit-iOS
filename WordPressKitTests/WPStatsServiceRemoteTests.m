...
- (void)testStreak
{
    ...
    [OHHTTPStubs stubRequestsPassingTest:^BOOL(NSURLRequest *request) {
        return [[request.URL absoluteString] hasPrefix:@"https://public-api.wordpress.com/rest/v1.1/sites/123456/stats/streak/?endDate=2016-01-28&startDate=2014-01-01&max=3000"];
    } withStubResponse:^OHHTTPStubsResponse *(NSURLRequest *request) {
